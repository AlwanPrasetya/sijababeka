...
$tunjangan_kendaraan = $_POST['tunjangan_kendaraan'];
$total_sallary_gross = $_POST['total_sallary_gross'];

// Data BPJS dan lainnya
$bpjs_jht = $_POST['bpjs_jht'];
$bpjs_jp = $_POST['bpjs_jp'];
$bpjs_ks = $_POST['bpjs_ks'];
$koperasi_karyawan = $_POST['koperasi_karyawan'];
$total_sallary_nett = $_POST['total_sallary_nett'];
...
try {
  ...
  $sql = "INSERT INTO hcc (fpk_selection, id_candidates, nama_kandidat, golongan, form_tanggal_lengkap, branch, no_ktp, jabatan, pendidikan, organisasi, alasan_penerimaan, 
                           gaji_pokok, tunjangan_makan, tunjangan_transport, tunjangan_kendaraan, total_sallary_gross,
                           bpjs_jht, bpjs_jp, bpjs_ks, koperasi_karyawan, total_sallary_nett,
                           ...
                           bpjs_ketenagakerjaan, bpjs_jaminan_pensiun)
            VALUES (:fpk_selection, :id_candidates, :nama_kandidat, :golongan, :form_tanggal_lengkap, :branch, :no_ktp, :jabatan, :pendidikan, :organisasi, :alasan_penerimaan, 
                    :gaji_pokok, :tunjangan_makan, :tunjangan_transport, :tunjangan_kendaraan, :total_sallary_gross,
                    :bpjs_jht, :bpjs_jp, :bpjs_ks, :koperasi_karyawan, :total_sallary_nett,
                    :form_aplikasi, :pas_foto, :form_interview_user, :foto_ktp, :form_interview_hr, :foto_ijazah,
                    :form_hasil_psikotest, :foto_transkip_nilai, :form_confirmation_letter, :foto_buku_tabungan,
  ...
  $stmt->bindParam(':tunjangan_makan', $tunjangan_makan);
  $stmt->bindParam(':tunjangan_transport', $tunjangan_transport);
  $stmt->bindParam(':tunjangan_kendaraan', $tunjangan_kendaraan);
  $stmt->bindParam(':total_sallary_gross', $total_sallary_gross);

  // Bind BPJS dan lainnya
  $stmt->bindParam(':bpjs_jht', $bpjs_jht);
  $stmt->bindParam(':bpjs_jp', $bpjs_jp);
  $stmt->bindParam(':bpjs_ks', $bpjs_ks);
  $stmt->bindParam(':koperasi_karyawan', $koperasi_karyawan);
  $stmt->bindParam(':total_sallary_nett', $total_sallary_nett);
