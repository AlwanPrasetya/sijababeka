                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update_karyawan_tetap.php" method="POST">
                            ...
                            <div class="form-group">
                                <label>Divisi</label>
                                <input type="text" name="nama_divisi" value="<?php echo $row['nama_divisi'] ?>" placeholder="Masukkan Divisi" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Department</label>
                                <input type="text" name="nama_department" value="<?php echo $row['nama_department'] ?>" placeholder="Masukkan Department" class="form-control" required>
                            </div>
                            <div class="form-group">
