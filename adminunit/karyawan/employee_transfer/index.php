        ...
        <div class="row">
            ...
            <script>
                document.getElementById("requestType").addEventListener("change", function() {
                    ...
                    } else if (selectedOption === "PHK" || selectedOption === "Resign" || selectedOption === "Karyawan Baru") {
                        ...
                        <div class="table-wrapper">
                            ...
                            <table id="myTable" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    // Query untuk mengambil data employee_transfer berdasarkan branch
                                    $query = mysqli_query($connection, "SELECT * FROM employee_transfer WHERE nama_unit = '$branch'");
