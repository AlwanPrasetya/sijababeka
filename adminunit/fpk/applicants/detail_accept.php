...
$query = "SELECT * FROM applicants WHERE level_candidates = 6";
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header" style="background-color: #008F4D; color: white; display: flex; align-items: center; padding: 10px;">
              <div class="title" style="padding: 5px; margin-right: 10px;">DATA ACCEPT</div>
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      if ($row['kodeFPK'] == $_GET['KodeFPK']) {
                        ...
                        echo "<td>" . $row['wa'] . "</td>";
        //                 echo "<td>
        //     <form action='move_accept.php' method='POST' style='display:inline;'>
        //         <input type='hidden' name='id' value='" . $row['id'] . "' />
        //         <button type='submit' name='moveAccept' class='btn-move'>Move</button>
        //     </form>
        // </td>";
                        echo "</tr>";
                      }
