...
$query = "SELECT * FROM applicants WHERE level_candidates = 1";
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header" style="background-color: #008F4D; color: white; display: flex; align-items: center; padding: 10px;">
              <div class="title" style="padding: 5px; margin-right: 10px;">DATA INTERVIEW HR</div>
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      if ($row['kodeFPK'] == $_GET['KodeFPK']) {
                        ...
                        echo "<td>" . $row['wa'] . "</td>";
                        echo "<td>
            <form action='move_interview_hr.php' method='POST' style='display:inline;'>
                <input type='hidden' name='id' value='" . $row['id'] . "' />
                <button type='submit' name='moveInterviewHr' class='btn-move'>Move</button>
            </form>
        </td>";
                        echo "</tr>";
                      }
