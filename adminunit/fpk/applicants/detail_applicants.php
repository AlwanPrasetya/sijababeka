    ...
    <div class="container-content">
        <div class="container" style="margin-top: 80px">
            <div class="row">
                ...
                <div class="d-flex justify-content-end ml-3 mb-1" style="background-color: yellowgreen; border-radius: 7px; height: 110px;">
                    <!-- Tombol "Tambah Pelamar" -->
                    <button id="btnTambahPelamar" class="btn text-white">
                        ...
                        <i>Add <br> Applicants</i>
                    </button>
                </div>
                <div class="d-flex justify-content-end ml-1 mb-1" style="background-color: yellowgreen; border-radius: 7px; height: 110px;">
                    <button class="btn text-white" onclick="location.href='tambah_applicant.php'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 24 24">
                            <rect width="24" height="24" fill="none" />
                            <path fill="currentColor" d="m12 18l4-5h-3V2h-2v11H8z" />
                            <path fill="currentColor" d="M19 9h-4v2h4v9H5v-9h4V9H5c-1.103 0-2 .897-2 2v9c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-9c0-1.103-.897-2-2-2" />
                        </svg><br>
                        <i>Import<br> Applicants</i></button>
                </div>
                <div class="col-md-12">
                    <div class="card">
