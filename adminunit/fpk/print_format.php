...
if (isset($_GET['id_fpk'])) {
    ...
    <tbody>
        ...
        <tr>
            <td style='padding-top: 10px; padding-bottom: 10px; padding-left: 10px;'>ORGANISASI : " . $row['organisasi'] . "</td>
    ...
    <td colspan=\"2\" style='width: 50%; padding-top: 10px; padding-bottom: 10px; padding-left: 10px;'>JURUSAN : " . $row['major'] . "</td>
        ...
        $userSignatureClass = ($row["persetujuanUser"] == "Disetujui") ? "hidden" : "";
    ...
    <td style='width: 33%; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px; text-align: center;'>
        ...
        <div style='flex: 1;'>
            ...
            <img src='ttd/img/alwan.png' alt='Tanda Tangan User' class='<?php echo $userSignatureClass; ?>' style='max-width: 100%; height: auto;'>
        </div>
