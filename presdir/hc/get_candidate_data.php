...
if (isset($_POST['id_candidates'])) {
  ...
  $sql = "
        SELECT 
            ...
            h.confirmation_letter AS confirmation_letter, 
            h.file_hasil_tes_kesehatan AS file_hasil_tes_kesehatan
        FROM 
            applicants a
        LEFT JOIN 
        ...
        LEFT JOIN 
            hc h ON a.id_candidates = h.id_candidates AND h.kodeFPK = f.kodeFPK
        WHERE
            a.id_candidates = ?
    ";
