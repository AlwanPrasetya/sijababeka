...
$query = "SELECT * FROM status WHERE id_status = $id LIMIT 1";
                    ...
                    <div class="card-body">
                        <form action="update_status.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_status" value="<?php echo $row['nama_status'] ?>" placeholder="Masukkan Nama status" class="form-control">
                            </div>
