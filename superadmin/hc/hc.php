                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (!response.error) {
                                ...
                                setBpjsKs(response.bpjs_ks); // Perbaikan penamaan fungsi di sini
                    ...
                    <table style="margin-left: 20px;  width: 100%;">
                        ...
                        <tr class="table-container">
                            <td style="width: 70%; vertical-align: middle; height: 5px; padding-right: 20px;">
                                <div class="table-cell">
                                    <label for="check_gaji_pokok" style="width: 250px;">Gaji Pokok</label>
                                    <div style="margin-bottom: -10px; display: flex; align-items: center; width: 90%;">
                            ...
                            <td rowspan="3" style="width: 45%; vertical-align: middle; height: 5px;">
                                <div class="table-cell">
                                    ...
                                    <div style="margin-bottom: -10px; display: flex; align-items: center; width: 100%;">
                                        <textarea type="text" id="form_catatan" name="form_catatan" style="width: 100%; height: 100px;" required></textarea>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="table-container">
                            <td style="width: 45%; vertical-align: middle; height: 5px; padding-right: 20px; background-color: #f0f0f0;">
                                <div class="table-cell">
                                    ...
                                    <div style="margin-bottom: -10px; display: flex; align-items: center; width: 90%;">
                                        <input type="text" id="check_total_sallary_gross" name="check_total_sallary_gross" placeholder="Total Sallary Gross" style="font-weight: bold; background-color: #f0f0f0;" readonly>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="table-container">
                            <td style="width: 55%; vertical-align: middle; height: 5px; padding-right: 20px;">
                                <div class="table-cell">
                                    <label for="check_bpjs_jp" style="width: 250px;">BPJS Ketenagakerjaan (JP)</label>
                                    <div style="margin-bottom: -10px; display: flex; align-items: center; width: 90%;">
                        ...
                        <tr class="table-container">
                            <td style="width: 45%; vertical-align: middle; height: 5px; padding-right: 20px; background-color: #f0f0f0;">
                                <div class="table-cell">
                                    ...
                                    <div style="margin-bottom: -10px; display: flex; align-items: center; width: 90%;">
                                        <input type="text" id="check_total_sallary_nett" name="check_total_sallary_nett" placeholder="Total Sallary Nett" style="font-weight: bold; background-color: #f0f0f0;" readonly>
                                    </div>
                                </div>
                            </td>
                        </tr>
