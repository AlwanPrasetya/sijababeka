...
$query = "SELECT * FROM bisnis WHERE id_unit = $id LIMIT 1";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update_bisnis.php" method="POST">
                            <!-- Tambahkan input tersembunyi untuk id siswa -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_unit" value="<?php echo $row['nama_unit'] ?>" placeholder="Masukkan Nama Bisnis" class="form-control">
                            </div>
