...
<script>
    function validateForm() {
        ...
        var unit = document.getElementById('nama_unit').value;
        if (kode == "" || unit == "") {
...
<h2><center>FORM INPUT BISNIS UNIT</center></h2>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="save_bisnis.php" method="POST" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                <label for="nama_unit">Nama Bisnis</label>
                                <input type="text" id="nama_unit" name="nama_unit" placeholder="Masukkan Nama Bisnis" class="form-control">
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        include('koneksi.php');
                                        $no = 1;
                                        $query = mysqli_query($connection, "SELECT * FROM bisnis");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="edit_bisnis.php?id=<?php echo $row['id_unit'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                                                    <a href="delete_bisnis.php?id=<?php echo $row['id_unit'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                                </td>
                                            </tr>
