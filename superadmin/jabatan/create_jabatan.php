...
{
    $query = "SELECT COUNT(*) as total FROM jabatan WHERE nama_kode = '$kode'";
...
// Pada bagian penyimpanan data (save_jabatan.php), tambahkan kode untuk memeriksa keunikan kode sebelum menyimpan data
...
<h2><center>FORM INPUT JABATAN</center></h2>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="save_jabatan.php" method="POST" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_jabatan" name="nama_jabatan" placeholder="Masukkan Nama jabatan" class="form-control">
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <a href="create_jabatan.php" class="btn btn-md btn-success mb-3">TAMBAH DATA</a> -->
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="edit_jabatan.php?id=<?php echo $row['id_jabatan'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                                                    <a href="delete_jabatan.php?id=<?php echo $row['id_jabatan'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                                </td>
                                            </tr>
