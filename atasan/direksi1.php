...
<head>
	...
	<title>Dashboard Direksi 1</title>
...
<body>
	...
	if (isset($_GET['id'])) {
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				$nama = $row["nama"];
				echo "<h4>SELAMAT DATANG, <strong> $nama </strong> - <strong> Direksi 1 </strong></h4>";
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<a href="./fpk/Data.php?id=<?php echo $userId; ?>&branch=<?php echo $branch; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
