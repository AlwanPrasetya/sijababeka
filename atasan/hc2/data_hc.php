...
<body>
          ...
          <table class="table table-bordered bg-white" id="myTable">
            ...
            <tbody>
              ...
              if (isset($_GET['branches'])) {
                ...
                $sql = "SELECT hcc.*, persetujuan_hc.Status_Penyetujuan, persetujuan_hc.persetujuanAtasan, persetujuan_hc.persetujuanDireksi2 
            FROM hcc 
            ...
            $whereClause";
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . $row["persetujuanDireksi2"] . "</td>";
                  ...
                  // Print Button
                  echo "<button type='button' class='btn btn-success print-btn' onclick='printFPK(" . $row["fpk_selection"] . ")'><svg xmlns='http://www.w3.org/2000/svg' width='1.2em' height='1.2em' viewBox='0 0 512 512'>
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      // Menambahkan tombol Reject
      echo "<button type='button' class='btn btn-primary approve-btn' data-id='" . $row["fpk_selection"] . "' data-persetujuandireksi2='" . $row["persetujuanDireksi2"] . "'>Approve <svg xmlns='http://www.w3.org/2000/svg' width='1.2em' height='1.2em' viewBox='0 0 24 24'>
        <rect width='24' height='24' fill='none' />
    ...
    $('.approve-btn').click(function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          var persetujuanDireksi2 = button.data('persetujuandireksi2');
