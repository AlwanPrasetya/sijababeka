...
<head>
	...
	<title>Dashboard Direksi 2</title>
...
<body>
	...
	if (isset($_GET['id'])) {
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				$nama = $row["nama"];
				echo "<h4>SELAMAT DATANG, <strong> $nama </strong> - <strong> Direksi 2 </strong></h4>";
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<a href="./fpk2/Data.php?id=<?php echo $userId; ?>&branch=<?php echo $branch; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
			...
			<div class="col-md-6">
				<a href="./hc2/data_hc.php?id=<?php echo $userId; ?>&branches=<?php echo $branches; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
