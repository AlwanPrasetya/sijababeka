...
if (isset($_GET['branches'])) {
    ...
    // Lakukan sesuatu dengan nilai branches yang telah diambil, misalnya menyimpannya dalam variabel atau menggunakan nilainya dalam operasi lainnya
    // echo "Nilai branches yang diterima dari URL: " . $branches;
} else {
    // Jika nilai branches tidak ditemukan dalam URL
...
<a href="../direksi3.php?id=<?php echo $userId; ?>" class="top-left-button">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="myTable" style="white-space: nowrap; overflow:hidden; text-overflow:ellipsis;">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT fpk.*, persetujuan.Status_Penyetujuan, persetujuan.persetujuanAtasan, persetujuan.persetujuanAdmin FROM fpk LEFT JOIN persetujuan ON fpk.kodeFPK = persetujuan.kodeFPK WHERE fpk.namaUnit = '$branches'";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row["persetujuanDireksi3"] . "</td>";
                                            ...
                                            if ($row["Status_Penyetujuan"] == "Approved") {
                                                echo "<td><button type='button' class='btn $buttonColor detail-btn' data-toggle='modal' data-target='#approvedModal" . $row["id_fpk"] . "'><svg xmlns='http://www.w3.org/2000/svg' width='1.5em' height='1.5em' viewBox='0 0 22 21'>
                                                ...
                                                echo "<td><button type='button' class='btn $buttonColor detail-btn' data-toggle='modal' data-target='#pendingModal" . $row["id_fpk"] . "'><svg xmlns='http://www.w3.org/2000/svg' width='1.5em' height='1.5em' viewBox='0 0 24 24'>
                                            ...
                                            echo "<p>Persetujuan Direksi (3)  : " . $row["persetujuanAtasan"] . " | " . $row["namaAtasan"] . " | " . $row["tglAtasan"] . "</p>";
