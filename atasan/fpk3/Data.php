                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="myTable" style="white-space: nowrap; overflow:hidden; text-overflow:ellipsis;">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT fpk.*, persetujuan.Status_Penyetujuan, persetujuan.persetujuanAtasan, persetujuan.persetujuanAdmin FROM fpk LEFT JOIN persetujuan ON fpk.kodeFPK = persetujuan.kodeFPK WHERE fpk.branch = '$branches'";
