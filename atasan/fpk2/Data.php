...
<a href="../direksi2.php?id=<?php echo $userId; ?>" class="top-left-button">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<p>Persetujuan Direksi (2)  : " . $row["persetujuanAtasan"] . " | " . $row["namaAtasan"] . " | " . $row["tglAtasan"] . "</p>";
