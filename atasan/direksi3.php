...
<head>
	...
	<title>Dashboard Direksi 3</title>
...
<body>
	...
	if (isset($_GET['id'])) {
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				$nama = $row["nama"];
				echo "<h4>SELAMAT DATANG, <strong> $nama </strong> - <strong> Direksi 3 </strong></h4>";
	...
	$connection->close();
	?>
	<a href="./fpk3/ttd.php?id=<?php echo $userId; ?>&branch=<?php echo $branch; ?>" class="card-link" style="position: absolute; top: 20px; right: 20px;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<a href="./fpk3/Data.php?id=<?php echo $userId; ?>&branches=<?php echo $branches; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
			...
			<div class="col-md-6">
				<a href="./hc3/hc.php?id=<?php echo $userId; ?>&branches=<?php echo $branches; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
