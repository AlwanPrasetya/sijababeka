...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result_select_kodeFPK->num_rows > 0) {
        ...
        if ($result_check_employee->num_rows > 0) {
            ...
            // Jika sudah ada, lakukan pembaruan nilai persetujuanUser
            $sql_update_persetujuan = "UPDATE persetujuan SET persetujuanUser = 'Ditolak' WHERE kodeFPK = ?";
            ...
            if ($stmt_update_persetujuan->execute()) {
                ...
                $sql_update_fpk = "UPDATE fpk SET persetujuanUser = 'Ditolak' WHERE id_fpk = ?";
            ...
            $sql_insert_persetujuan = "INSERT INTO persetujuan (kodeFPK, persetujuanUser, PersetujuanAdmin, Status_Penyetujuan) 
