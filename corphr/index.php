...
<body>
	...
	if (isset($_GET['id'])) {
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				$nama = $row["nama"];
				echo "<h4>SELAMAT DATANG, <strong> $nama </strong> - <strong> Corporate Human Resource </strong></h4>";
				...
				$resultBranches = $koneksi->query($queryBranches);
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<a href="./fpk/Data.php?id=<?php echo $userId; ?>&branches=<?php echo $branches; ?>" class="card-link">
					<div class="card">
						<div class="card-body">
