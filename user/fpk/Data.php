                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="myTable" style="white-space: nowrap; text-overflow:ellipsis;">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>ID FPK</th>
                                        <th>Nama</th>
                                        <th>Persetujuan User</th>
                                        <th>Approval</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                ...
                                // Pastikan nilai 'id' ada dalam URL
                                if (isset($_GET['id'])) {
                                    // Ambil nilai 'id' multi-user dari URL
                                    $userId = $_GET['id'];

                                    // Sanitasi nilai 'id' untuk mencegah SQL Injection
                                    $userId = $connection->real_escape_string($userId);

                                    // Ubah query SQL untuk mengambil nilai 'branch' dari tabel multi_user
                                    $query = "SELECT branch FROM multi_user WHERE id = '$userId'";

                                    // Jalankan kueri SQL untuk mengambil nilai 'branch'
                                    ...
                                    if ($result) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            // Ambil nilai 'branch' dari hasil kueri
                                            $row = $result->fetch_assoc();
                                            $branch = $row['branch'];

                                            // Gunakan nilai 'branch' untuk mengambil data yang sesuai dari tabel fpk
                                            ...
                                            // Periksa apakah kueri berhasil dieksekusi
                                            if ($result_fpk) {
                                                if ($result_fpk->num_rows > 0) {
                                                    while ($row_fpk = $result_fpk->fetch_assoc()) {
                                                        echo "<tr>";
                                                        echo "<td>" . $no++ . "</td>";
                                                        echo "<td>" . $row_fpk["kodeFPK"] . "</td>";
                                                        echo "<td>" . $row_fpk["NamaFPK"] . "</td>";
                                                        echo "<td>" . $row_fpk["persetujuanUser"] . "</td>";
                                                        // Menentukan warna tombol berdasarkan status persetujuan
                                                        $buttonColor = ($row_fpk["Status_Penyetujuan"] == "Approved") ? "btn-success" : "btn-danger";

                                                        // Menampilkan tombol dengan warna yang sesuai dan menentukan target modal
                                                        if ($row_fpk["Status_Penyetujuan"] == "Approved") {
                                                            echo "<td><button type='button' class='btn $buttonColor detail-btn' data-toggle='modal' data-target='#approvedModal" . $row_fpk["id_fpk"] . "'><svg xmlns='http://www.w3.org/2000/svg' width='1.2em' height='1.2em' viewBox='0 0 32 32'>
                                                            ...
                                                            echo "<td><button type='button' class='btn $buttonColor detail-btn' data-toggle='modal' data-target='#pendingModal" . $row_fpk["id_fpk"] . "'><svg xmlns='http://www.w3.org/2000/svg' width='1.6em' height='1.4em' viewBox='0 0 21 22'>
                                                        ...
                                                        echo "<button type='button' class='btn btn-primary detail-btn center-icon' data-toggle='modal' data-target='#detailModal" . $row_fpk["id_fpk"] . "' style='margin-right: 5px;'>
                                                        ...
                                                        echo "<button type='button' class='btn btn-success print-btn' onclick='printFPK(" . $row_fpk["id_fpk"] . ")'><svg xmlns='http://www.w3.org/2000/svg' width='1.2em' height='1.2em' viewBox='0 0 512 512'>
                                                        ...
                                                        echo "<div class='modal fade' id='approvedModal" . $row_fpk["id_fpk"] . "' tabindex='-1' role='dialog' aria-labelledby='approvedModalLabel' aria-hidden='true'>";
                                                        ...
                                                        echo "<p>Persetujuan Depthead: " . $row_fpk["persetujuanUser"] . " | " . $row_fpk["namaUser"] . " | " . $row_fpk["tglUser"] . "</p>";
                                                        echo "<p>Persetujuan HR Unit: " . $row_fpk["persetujuanAdmin"] . " | " . $row_fpk["namaAdmin"] . " | " . $row_fpk["tglAdmin"] . "</p>";
                                                        echo "<p>Persetujuan Direksi (1): " . $row_fpk["persetujuanAtasan"] . " | " . $row_fpk["namaAtasan"] . " | " . $row_fpk["tglAtasan"] . "</p>";
                                                        echo "<p>Persetujuan Direksi (2): " . $row_fpk["persetujuanDireksi2"] . " | " . $row_fpk["namaDireksi2"] . " | " . $row_fpk["tglDireksi2"] . "</p>";
                                                        echo "<p>Persetujuan Direksi (3): " . $row_fpk["persetujuanDireksi3"] . " | " . $row_fpk["namaDireksi3"] . " | " . $row_fpk["tglDireksi3"] . "</p>";
                                                        echo "<p>Persetujuan Presdir: " . $row_fpk["persetujuanPresdir"] . " | " . $row_fpk["namaPresdir"] . " | " . $row_fpk["tglPresdir"] . "</p>";
                                                        echo "<p>Persetujuan Corp HR: " . $row_fpk["persetujuanCorpHr"] . " | " . $row_fpk["namaCorpHr"] . " | " . $row_fpk["tglCorpHr"] . "</p>";
                                                        echo "<p>Persetujuan Super Admin: " . $row_fpk["persetujuanSuperadmin"] . " | " . $row_fpk["namaSuperadmin"] . " | " . $row_fpk["tglSuperadmin"] . "</p>";
                                                        echo "</div>";
                                                        ...
                                                        echo "<div class='modal fade' id='pendingModal" . $row_fpk["id_fpk"] . "' tabindex='-1' role='dialog' aria-labelledby='pendingModalLabel' aria-hidden='true'>";
                                                        echo "<div class='modal-dialog' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                        echo "<div class='modal-header'>";
                                                    ...
                                                    echo "<tr><td colspan='5'>Tidak ada data FPK yang sesuai</td></tr>";
                                                }
                                            } else {
                                                // Tampilkan pesan kesalahan jika kueri fpk gagal dieksekusi
                                                echo "<tr><td colspan='5'>Error: " . $connection->error . "</td></tr>";
                                            }
                                        } else {
                                            // Tampilkan pesan jika tidak ditemukan nilai 'branch' untuk ID multi-user tersebut
                                            echo "<tr><td colspan='5'>Tidak ditemukan nilai 'branch' untuk ID multi-user tersebut.</td></tr>";
                                        }
                                    } else {
                                    ...
                                    // Tampilkan pesan jika nilai 'id' tidak ditemukan dalam URL
                                    echo "<tr><td colspan='5'>Nilai 'id' tidak ditemukan dalam URL.</td></tr>";
                                }
    ...
    $('.approve-btn').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Simpan nilai persetujuanUser dari tombol
                var persetujuanUser = button.data('persetujuanuser');

                // Jika persetujuan HR Unit disetujui, tambahkan tanggal hari ini ke field tglAdmin
                if (persetujuanUser === 'Disetujui') {
