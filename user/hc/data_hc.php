            ...
            $whereClause";
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  // Detail Button
                  echo "<button type='button' class='btn btn-primary detail-btn center-icon' data-toggle='modal' data-target='#detailModal" . htmlspecialchars($row["fpk_selection"]) . "' style='margin-right: 5px;'>
